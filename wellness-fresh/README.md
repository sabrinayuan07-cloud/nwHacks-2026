...
A wellness community app built by students, for students. This is our hackathon project for nwHacks 2026.
...
So basically, we wanted to make something that actually helps students. College can be rough - there's a lot of pressure, stress, and sometimes it feels like you're just going through the motions alone. We built Ripple to create a space where students can connect with each other around wellness activities and support.
